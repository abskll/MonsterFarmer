...
{
    /**
	 * would deprecate this and use BasicAnimatedImage if I had time
	 */
	...
	public boolean intersects(BasicAnimatedImage basicAnimatedImage) {
		// TODO Auto-generated method stub
		return basicAnimatedImage.getBoundary().intersects( this.getBoundary() );
	}
}