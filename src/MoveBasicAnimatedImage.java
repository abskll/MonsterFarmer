...
public class MoveBasicAnimatedImage implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = -3905101181327350434L;
	transient BasicAnimatedImage sprite;
	public MoveBasicAnimatedImage(BasicAnimatedImage sprite) {
		this.sprite = sprite;
		sprite.setRight();
	}
	public void setSprite(BasicAnimatedImage sprite) {
		this.sprite = sprite;
		sprite.setRight();
	}
